...
1. **记录关键信息**（每家公司的 JD 要求各不相同，需解析并存入数据库）：
    a. 公司名称、城市、岗位、拿到 Offer 的时间。
    b. 薪资、入职时间、体检、签证或毕业证明等具体要求。
2. **截止日期管理**：
...
1. **多维对比**：当用户手握多家 Offer 时，按以下维度并排对比——
    a. 实薪（到手）
    b. 薪资结构（底薪 / 奖金 / 股票 / 补贴）
    c. 城市
    d. 成长风格（业务 / 技术 / 管理）
...
- **FR-21 Coffee Chat 记录**：记录对象——
    - 性别、生日、公司、岗位
    - 教育背景（学校、专业、年限、毕业时间）
    - 工作经历、性格特点
    - Referral 意愿
    - 内推后记录时间、公司与后续 follow-up
- **FR-22 合同审查**：解析用户合同内容与想法，核对常见条款；缺失关键信息时帮用户提出——
    - 违约金 / 试用期 / 竞业 / Notice / 年假 / 医保
