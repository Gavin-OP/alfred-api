...
- [PRD：job-seeking](./prd/job-seeking.md) — NFR-4（缺失信息·人工补齐优先）、工作流一缺失補全闭环 + 子项层级、工作流二触发条件 / 推荐迭代闭环 / 文件交付；工作流三官网投递说明 + 投递台账嵌套列表；工作流四/五对调（面试准备上移为四、面试信息追踪下移为五，物理位置与编号一并调整）；工作流九/十一/十四/十五与 FR-21/FR-22 内联枚举拆独立子项；子项改嵌套有序列表
